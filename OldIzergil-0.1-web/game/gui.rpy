...
define gui.text_font = "gui/fonts/Century Old Style Regular.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "gui/fonts/Century Old Style Bold.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "gui/fonts/Neuzeit Antiqua.ttf"
